...
# Patch from upstream: fixes iptables cgroup access issue
Patch1: 0001-Allow-iptables-list-cgroup-dirs.patch
...
%changelog
* Fri Dec 01 2023 Skip Grube <sgrube@ciq.com> - 3.14.3-96.1
